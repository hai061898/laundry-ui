...
class CardOrder extends StatelessWidget {
  final Order? order;
  CardOrder({ Key? key , this.order}) : super(key: key);
  final DateFormat formatter = DateFormat("yyyy MM dd");
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: ()=>Get.to(DetailOrder()),
      child: Container(  
            ...
            Expanded(
              child: Column(  
                ...
                children: [
                  ...
                  textRow("Place On", formatter.format(order!.placedDate!)),
                   SizedBox(
                    height: 5.0,
                  ),
                  textRow("Delivery", formatter.format(order!.arrivalDate!))
                ],
              ),
            ),
           ],
